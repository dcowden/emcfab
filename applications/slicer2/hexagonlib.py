...
class Hexagon:
	...
	def makeHexForBoundingBox(self,bottomLeftCorner,topRightCorner):
		...
		#display.DisplayShape( OCCUtil.make_vertex( gp.gp_Pnt(bottomLeftCorner[0],bottomLeftCorner[1],bottomLeftCorner[2])));
		#display.DisplayShape( OCCUtil.make_vertex( gp.gp_Pnt(bottomLeftCorner[0],topRightCorner[1],bottomLeftCorner[2])));
		#display.DisplayShape( OCCUtil.make_vertex( gp.gp_Pnt(topRightCorner[0],bottomLeftCorner[1],bottomLeftCorner[2])));
		#display.DisplayShape( OCCUtil.make_vertex( gp.gp_Pnt(topRightCorner[0],topRightCorner[1],bottomLeftCorner[2])));
